    ...
    <footer style={{ backgroundColor: "#fbfbfb" }} className="border-top">
      <div className="container mt-5">
        <div className="row mt-5">
          <div className="col">
            <img src="media/images/logo.png" style={{ width: "60%" }} className="mb-3" />
            <p className="mb-4">&copy; 2010 - 2025, TradeWell Broking Ltd. All rights reserved.</p>
          ...
          <div className="col footer-nav">
            ...
            <a href="">Careers</a>
            <br />
            <a href="">TradeWell.tech</a>
            <br />
            <a href="">Press & media</a>
            <br />
            <a href="">TradeWell Cares (CSR)</a>
            <br />
          </div>
          <div className="col footer-nav">
            <p>Support</p>
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          <p>
            TradeWell Broking Ltd.: Member of NSE, BSE​ &​ MCX – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through TradeWell Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Commodity Trading through TradeWell Commodities Pvt. Ltd. MCX: 46025; NSE-50001 – SEBI Registration no.: INZ000038238 Registered Address: TradeWell Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to complaints@tradewell.com, for DP related to dp@tradewell.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF Procedure to file a complaint on SEBI SCORES: Register on SCORES portal. Mandatory details for filing complaints on SCORES: Name, PAN, Address, Mobile Number, E-mail ID. Benefits: Effective Communication, Speedy redressal of the grievances Smart Online Dispute Resolution | Grievances Redressal
            Mechanism
          </p>
          <br />
          <p>
